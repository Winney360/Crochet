...
<button
  ...
  className="lg:hidden p-3 rounded-2xl bg-linear-to-r from-pink-400 to-cyan-400 text-white shadow-lg hover:shadow-xl transition-all duration-500 transform hover:scale-105 hover:from-pink-500 hover:to-cyan-500"
>
  {isMenuOpen ? (
    ...
    <div className="absolute top-0 right-0 h-full w-80 bg-white/95 shadow-2xl border-l border-pink-200/50 transform transition-all duration-700 animate-slideInRight">
      ...
      <div className="absolute bottom-0 left-0 right-0 bg-white/95 border-t border-pink-100 rounded-t-3xl shadow-2xl p-4 animate-slideUp">
        ...
        <Link 
          to="/contact"
          onClick={() => setIsMenuOpen(false)}
          className="text-center bg-linear-to-r from-pink-50 to-cyan-50 rounded-2xl p-3 border border-pink-100/50 animate-pulse-slow hover:scale-105 transition-all duration-300 cursor-pointer block"
        >
