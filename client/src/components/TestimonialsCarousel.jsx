      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="flex items-center justify-center gap-6 mb-12">
          ...
          <button 
            ...
            className="p-3 rounded-full bg-cyan-400 text-white hover:bg-cyan-600 transition-all duration-300 shadow-lg hover:shadow-xl"
          >
          ...
          <button 
            ...
            className="p-3 rounded-full bg-pink-400 text-white hover:bg-pink-600 transition-all duration-300 shadow-lg hover:shadow-xl"
          >
